                ...
                <h2><strong><a href="tel:+79616949949">+7(961)-6-949-949</a></strong></h2>
		       	...
		       	<div class="nav">
				    <ul class="menu-main">
                     ...
                     <div class="logo"><a href="index.php"><img src="img/logo.jpg" alt="logotype"></a></div>
                </div>
            </div>
            <div class="header">
                <div class="navadaptive" id="layer">
		    ...
		    <div class="body">
		    	...
		    	<div class="figure">
			        ...
			        <figure class="picturesix">
			        	<p><a href="iphonexsmax.html"><img src="img/iphonexsmax.jpg" alt="iphone"></a></p>
