...
<html lang="en">
	...
	<body>
		<h1>THE BLACK CASE</h1>
		<h2><strong>+7(961)-6-949-949</strong></h2>
		<h2><strong><a href="map.html">Мы находимся здесь</a></strong></h2>
		<nav class="top-menu">
			<ul class="menu-main">
				<li class="left-item"><a href="index.php" class="down">Телефоны</a></li>
					<ul class="submenu">
						<li class="left-item"><a href="applephone.html">Apple</a></li>
				...
				<a class="navbar-logo" href="index.php"><img src="img/logo.jpg" alt="photo"></a>
		</nav>
		<h3>Популярные смартфоны и чехлы</h3>
		<figure class="pictureone">
			<p><a href="flamingo.html"><img src="img/flamingo.jpg" width="150" height="200" alt="photo"></a></p>
			<figcaption><h4><a href="flamingo.html">Чехол Flamingo</a></h4></figcaption>
		</figure>
		<figure class="picturetwo">
			<p><a href="pink.html"><img src="img/pink.jpg" width="150" height="200" alt="photo"></a></p>
			<figcaption><h4><a href="pink.html">Чехол KRY</a></h4></figcaption>
		</figure>
		<figure class="picturethree">
			<p><a href="kisscase.html"><img src="img/kisscase.jpg" width="150" height="200" alt="photo"></a></p>
			<figcaption><h4><a href="kisscase.html">Чехол Kisscase</a></h4></figcaption>
		</figure>
		<figure class="picturefour">
			<p><a href="miezupro8.html"><img src="img/meizupro8.jpg" width="150" height="200" alt="photo"></a></p>
			<figcaption><h4><a href="miezupro8.html">Meizu Pro 8</a></h4></figcaption>
		</figure>
		<figure class="picturefive">
			<p><a href="samsungs9.html"><img src="img/samsungs9.jpg" width="150" height="200" alt="photo"></a></p>
			<figcaption><h4><a href="samsungs9.html">Samsung Galaxy S9</a></h4></figcaption>
		</figure>
		<figure class="picturesix">
			<p><a href="iphonexsmax.html"><img src="img/iphonexsmax.jpg" width="150" height="200" alt="photo"></a></p>
			<figcaption><h4><a href="iphonexsmax.html">Iphone XS Max</a></h4></figcaption>
		</figure>
		<div class="footer">
